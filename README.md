# Available .MBA One-Word Domains (9,398)
...
Daily-updated dataset of available and resale .mba one-word domains from Unique Domains.

> **Note:** this repository currently mirrors the full live catalog for this exact search.
> Unique Domains counts can still change as the search refreshes.

**Public extract:** 9,398 rows · **Live catalog:** 9,398 domains
...
| clear.mba      | available | $19.99    | $50.99        | 90             | 49     | 5      | name.com         |
...
| ----------------------- | ------------------------------------------------ |
| 9,398-row public sample | 9,398 live domains                               |
...
> Unique Domains. *Available .MBA One-Word Domains*. Version 2026-04-13. Public GitHub extract for the exact Unique Domains search represented by this repository.
